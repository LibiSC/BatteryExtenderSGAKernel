...
/*#define INTERACTIVEX_HACK*/

#ifdef INTERACTIVEX_HACK
#define DRIVER_DEFAULT_NR_RUNNING_ADDR 0xc009aa04 /*Galaxy Ace 2.6.35.7-perf-CL514579*/
...
MODULE_PARM_DESC(nr_running_addr, "The nr_running address (default 0xc009aa04)");
#endif
